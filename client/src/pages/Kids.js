...
const Kids = () => {
  ...
  let categ = queryString.parse(window.location.search)
    ...
    if (!data) return (
        <div>
            <p>Sorry we regret to tell you that Kids are out of Stock!!!<FaSadTear className='text-xl md:text-2xl mx-2' />
            </p>
            </div>
    )
      ...
      <div>
        ...
        <main className="max-w-full px-4 sm:px-6 lg:px-8">
          <div className="flex items-baseline justify-between border-b border-gray-200 pt-2 pb-6">
            <h1 className="text-4xl font-bold tracking-tight text-gray-900">Kids</h1>
