...
const HomeLiving = () => {
  ...
  let categ = queryString.parse(window.location.search)
    ...
    useEffect(() => {
        ...
        axios.get(`http://localhost:5000/product/`, {params:{cat}}).then((response) => {
    ...
    if (!data) return (
        <div>
            <p>Sorry we regret to tell you that HomeLiving are out of Stock!!!<FaSadTear className='text-xl md:text-2xl mx-2' />
            </p>
            </div>
    )
      ...
      <div>
        ...
        <main className="max-w-full px-4 sm:px-6 lg:px-8">
          <div className="flex items-baseline justify-between border-b border-gray-200 pt-2 pb-6">
            <h1 className="text-4xl font-bold tracking-tight text-gray-900">Home & Living</h1>
        ...
        return (
                        <div className="lg:w-1/5 md:w-1/2 p-3 w-full cursor-pointer shadow-xl m-4 " key={key}>
                            ...
                            <div className="mt-4 text-center md:text-left" >
                                <h3 className="text-gray-500 text-xs tracking-widest title-font mb-1">HomeLiving</h3>
                                ...
                                <div className="mt-1">
                                    ...
                                    {items.color.includes('Navy') && <button className="border-2 border-gray-300 bg-blue-900 rounded-full w-6 h-6 focus:outline-none"></button>}
                                </div>
                            </div>
                        </div>
                       ) })}
